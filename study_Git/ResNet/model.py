...
class ResNet(nn.Module):
    def __init__(self, block, blocks_num, num_classes=1000, include_top=False):
    ...
    def _make_layer(self, block, channel, block_num, stride=1):
        ...
        layers = []
        layers.append(block(self.in_channel, channel, stride=stride, downsample=downs_sample))
